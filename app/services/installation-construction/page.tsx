      ...
      <div>
        <div className="px-8 space-y-4">
          <ContentSection
            layout="image-left"
            image={{
              src: 'https://res.cloudinary.com/dfwty72r9/image/upload/v1753804208/Capture-construction_iq97pg.png',
              alt: 'installation',
            }}
            content={{
              subtitle: 'Who we are',
              ...
              paragraph:
                'Aprosol Installation & Construction - Engineering Support delivers skilled engineering and technical manpower to meet diverse project requirements across various industries. Our experienced professionals bring expertise in instrumentation, control systems, process engineering, mechanical engineering, electrical systems, and project management. We provide qualified personnel for both short-term assignments and long-term project deployments, ensuring seamless integration with your existing teams and operational excellence throughout project lifecycles.',
            }}
          />
          <ContentSection
            layout="image-right"
            image={{
              src: 'https://res.cloudinary.com/dfwty72r9/image/upload/v1752528122/jimmy-nilsson-masth-U3GiK1u5j24-unsplash_lhppnc.jpg',
              alt: 'construction',
            }}
            content={{
              // title: 'Procurement',
